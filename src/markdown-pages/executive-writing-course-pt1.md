...
nextPostLink: "/blog/executive-writing-course-pt2"
---
...
1. Добавляйте пробелы для облечения чтения,
2. Используйте уровни важности,
3. Упрощайте\
   &nbsp;&nbsp;-Первичная проверка\
...
Вместо "_Симпозиум является форумом для распространения информации и не предназначен для установления стандартов._"

Можно написать "_Симпозиум - это форум для обмена информацией, а не для установления стандартов._"

Вместо "_Начиная с 1 октября, адресаты должны будут использовать учетные записи, указанные в приложении. Адресаты прекратят отчетность по счетам расходов 1060, 2137 и 2340._"

Можно написать "_с 1 октября начните использовать учетные записи в приложении и прекратите использовать учетные записи 1060, 2137 и 2340._"
...
Вместо "_Я хотел бы поздравить вас с выбором в качестве нашего сотрудника месяца за июнь._"

Можно написать "_Поздравляем с избранием в качестве нашего сотрудника месяца в июне._"
